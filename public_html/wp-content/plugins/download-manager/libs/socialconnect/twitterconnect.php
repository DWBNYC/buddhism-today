...
class TwitterConnect {
	...
	function connectHelper() {
		...
		$request_token = $connection->oauth('oauth/access_token', ['oauth_verifier' => $_GET['oauth_verifier']]);
	...
	function follow($pid){
		...
		$status = $connection->post("friendships/create", ["screen_name" => $handle, 'follow' => true]);
