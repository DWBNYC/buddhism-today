...
class PackageLocks
{
    ...
    public static function GooglePlusOne($package, $buttononly = false)
    {
        ...
        return "<button class='wpdm-social-lock btn wpdm-google-plus' data-url='".SocialConnect::GooglePlusUrl($package['ID'])."'><i class='fa fa-google-plus'></i> Google +1</button>";
...
DATA;
  ...
  <div class="panel-body">
        ...
        ';
            ...
            $data .= $html;
            $data .= '
        <label>'.__('Send Download Link To:','wpdmpro').'</label>
