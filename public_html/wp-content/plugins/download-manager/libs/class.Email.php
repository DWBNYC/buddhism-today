        ...
        $templates = array(
            ...
            'email-lock' => array( 'label' => __('Email Lock Notification', 'wpdmpro'),
                ...
                'default' => array( 'subject' => __('Download [#package_name#]', 'wpdmpro'),
                                    'from_name' => get_option('blogname'),
                                    'from_email' => "do-not-reply@buddhism-today.org",
                                    'message' => 'Thanks for Downloading [#package_name#]<br/>Please click on following link if you need to download it again:<br/><b><a href="[#download_url#]">[#download_url#]</a></b><br/><br/><br/>Best Regards,<br/><b>[#sitename#]</b>'
                )
            ),
