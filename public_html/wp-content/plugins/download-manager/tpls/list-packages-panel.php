...
///$edit_url = isset($sparams['edit_page']) && $sparams['edit_page'] != ''?;
...
<div class="row">
    <div class="col-md-6"><a href="#" class="btn btn-primary btn-addnew"><i class="fa fa-plus-circle"></i> Add New</a> </div>
    <div class="col-md-2">
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <span title="<?php echo $post->post_status=='publish'?sprintf(__('Published On %s', 'wpdmpro'), get_the_date()):__('Pending Review', 'wpdmpro');?>" class="pull-right btn-xs btn wpdmtip btn-link <?php echo $post->post_status=='publish'?'text-success':'text-warning';?>"><?php echo $post->post_status=='publish'?'<i class="fa fa-check-circle"></i> ':'<i class="fa fa-hourglass"></i> ';?> <?php echo ucfirst($post->post_status);?></span>
