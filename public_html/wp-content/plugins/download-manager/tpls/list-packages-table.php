...
<input placeholder="🔎 &nbsp; <?php _e('Search...', 'wpdmpro'); ?>" type="text" id="sfld" class="form-control input-lg" name="q" value="<?php echo $Q; ?>">
    ...
    <th style="" class="manage-column column-media" id="media" scope="col" align="center"><?php _e('Actions', 'wpdmpro'); ?></th>
    </tr>
    </thead>
