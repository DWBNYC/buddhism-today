    ...
    <div class="panel panel-default dashboard-panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php if (isset($store['title'])) echo $store['title']; ?>" placeholder="<?php _e("Ex: Cool MP3", "wpdmpro"); ?>" id="" name="__wpdm_public_profile[title]" class="form-control">
            </div>
            <div class="form-group">
                <label><?php _e("Short Intro", "wpdmpro"); ?></label>
                <input type="text" value="<?php if (isset($store['intro'])) echo $store['intro']; ?>" placeholder="<?php _e("Ex: Free MP3 Musics", "wpdmpro"); ?>" id="" name="__wpdm_public_profile[intro]" class="form-control">
            </div>
            <div class="form-group">
