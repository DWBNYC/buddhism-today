...
<div class="wrap w3eden">
    <div class="panel panel-default" id="wpdm-wrapper-panel">
        <div class="panel-heading">
            ...
            <a style="margin-left: 10px" id="basic" href="edit.php?post_type=wpdmpro&page=emails&task=export" class="btn btn-sm btn-default pull-right"><i class="fa fa-table color-green"></i> <?php echo __('Export All','wpdmpro'); ?></a>
            <a id="basic" href="edit.php?post_type=wpdmpro&page=emails&task=export&uniq=1" class="btn btn-sm btn-default pull-right"><i class="fa fa-bars color-purple"></i> <?php echo __('Export Unique Emails','wpdmpro'); ?></a>&nbsp;
        </div>
